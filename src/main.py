...
# Env helpers (direct import, no re-export aliases)
from env_store import (
    write_env_var as _write_env_var,
    write_env_bool as _write_env_bool,
    read_env_var as _read_env_var,
    read_env_bool as _read_env_bool,
    _parse_bool,
)
...
from auth import (  # noqa: E402
    ...
    _delete_user,
    _is_root_username,
    _is_valid_session_cookie,
    _issue_session_cookie,
    _list_api_keys,
    _list_users,
    _login_credentials_configured,
...
from firewall import (  # noqa: E402
    _delete_external_interactions_entry,
    _external_interactions_enabled,
    _external_interactions_worker_bind_address,
    _list_external_interactions_entries,
    _load_external_interactions_entries,
    _set_external_interactions,
    _set_external_interactions_allow_new,
    _set_external_interactions_allow_new_outgoing,
...
from plugin_events import (  # noqa: E402
    _add_plugin_event,
    _add_plugin_to_event,
    _load_plugin_event_subscriptions,
    _remove_plugin_event,
    _remove_plugin_from_event,
)
from integrity import (  # noqa: E402
    _compute_local_project_hash,
    _get_current_plugins_lib_version,
    _get_current_project_version,
    _get_effective_plugins_lib_version,
    _get_effective_project_version,
    _get_indicated_plugins_lib_version,
    _get_indicated_project_version,
    _get_local_project_hash,
    _is_project_functionality_disabled,
...
# Shared Flask decorators / helpers live in app_factory (modularised)
from app_factory import (  # noqa: E402
    _options_response,
    _head_response,
...
app.after_request(set_connection_header)
